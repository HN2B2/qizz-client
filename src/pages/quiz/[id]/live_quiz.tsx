    ...
    const handleCreateQuiz = async () => {
        try {
            const data: any = await instance
                .post(`quiz/bankId/${router.query.id}`, {
                    json: {
            ...
            const quizData = await instance
                .put(`quiz/live_quiz/${data.quizId}`, {
                    json: body,
                })
                .json()
            notifications.show({
            ...
            <Container size="xs">
                ...
                <Paper p="lg" radius="md" shadow="sm" mt={20}>
                    ...
                    <Stack>
                        <Flex justify={"space-between"} gap={20} align="start">
                            <Stack gap={5}>
                                ...
                                <Text size="sm">
                                    Show students the correct answers after each
                                    question.
                                </Text>
                            </Stack>
                            <Switch
                    ...
                    <Flex justify={"space-between"} gap={20} align="start">
                        <Stack gap={5}>
                            ...
                            <Text size="sm">
                                Allow students to view answers after the quiz is
                                submitted.
                            </Text>
                        </Stack>
                        <Switch
                            onClick={() =>
                                setShowAnswersAfterAct(!showAnswersAfterAct)
                            }
                            onChange={() =>
                                form.setFieldValue(
                                    "showAnswersAfterAct",
                ...
                <Paper p="lg" radius="md" shadow="sm" mt={20}>
                    ...
                    <Stack>
                        <Flex justify={"space-between"}>
                            <Stack gap={5}>
                                ...
                                <Text size="sm">
                                    Students get bonus points and other fun
                                    abilities.
                                </Text>
                            </Stack>
                            <Switch
                                ...
                                onChange={() =>
                                    form.setFieldValue("powerUp", !powerUp)
                                }
                            />
                        </Flex>
                    </Stack>
                    ...
                    <Stack>
                        <Flex justify={"space-between"}>
                            <Text style={{ fontWeight: "500" }}>
                                Student live reactions
                            </Text>
                            <Switch
                                onClick={() => setReactions(!reactions)}
                                onChange={() =>
                                    form.setFieldValue("reactions", !reactions)
                                }
                            />
                        </Flex>
                    </Stack>
