        ...
        <Flex justify={"space-between"}>
          <Stack>
            <Group>
              ...
              {editing && (
                <Button variant="default" size="sm" onClick={handleEditName}>
                  Save
                </Button>
              )}
            </Group>
            <Group gap={4}>
              ...
              <Text>Started: {formatDate(quizReport.createdAt)}</Text>
            </Group>
          </Stack>
          ...
          {(quizReport.state === QuizState.STARTED ||
            ...
            <Group>
              <Button variant="outline" color="red" pos="relative" w={180}>
              ...
              <Paper p="sm" radius="md" withBorder w={"20%"}>
                <Group>
                  ...
                  <Stack gap={5}>
                    ...
                    <Text>{quizReport.totalParticipant}</Text>
                  </Stack>
                </Group>
              </Paper>
              <Paper p="sm" radius="md" withBorder w={"20%"}>
                <Group>
                  ...
                  <Stack gap={5}>
                    <Text>Question</Text>
                    <Text>{quizReport.questionReports.length}</Text>
                  </Stack>
                </Group>
              </Paper>
            </Flex>
...
export const getServerSideProps = async (
  ...
  const { quizId } = query;
  try {
    const { data }: { data: ReportDedailResponse } = await instance.get(
      `/reports/${quizId}`,
      {
